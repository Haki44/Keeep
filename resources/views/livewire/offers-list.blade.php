                            ...
                            @can('manage-offer', $offer)
                                <div class="flex justify-between mt-2">
                                    <div x-data="{ open{{$key}}: false }">
                                        <button @click="open{{$key}} = true" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Supprimer</button>
                                        <div x-show="open{{$key}}" class="overflow-x-hidden overflow-y-auto fixed h-modal md:h-full top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center flex bg-black bg-opacity-25">
                                            <div class="relative w-full max-w-2xl px-4 h-full md:h-auto">
                                                ...
                                                <div class="bg-white rounded-lg shadow relative">
                                                    ...
                                                    <div class="flex items-start justify-between p-5 border-b rounded-t">
                                                        ...
                                                        <button @click="open{{$key}} = false" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center">
                                                    ...
                                                    <div class="flex space-x-2 items-center p-6 border-t border-gray-200 rounded-b">
                                                        ...
                                                        <button @click="open{{$key}} = false" type="button" class="text-gray-900 hover:text-white border border-gray-800 hover:bg-gray-900 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Annuler</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
